...
export class CryptoApiClient {
     ...
     * @return Success
     */
    apiFiatBalancesGet(): Observable<FiatDTO[]> {
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            return this.processApiFiatBalancesGet(response_);
        }).catch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApiFiatBalancesGet(<any>response_);
                } catch (e) {
                    return <Observable<FiatDTO[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<FiatDTO[]>><any>Observable.throw(response_);
        });
    }

    protected processApiFiatBalancesGet(response: HttpResponseBase): Observable<FiatDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            response instanceof HttpErrorResponse ? response.error : undefined;
        ...
        return Observable.of<FiatDTO[]>(<any>null);
    }

    /**
     * @return Success
     */
    apiFundsGet(): Observable<FundDTO[]> {
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            return this.processApiFundsGet(response_);
        }).catch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApiFundsGet(<any>response_);
                } catch (e) {
                    return <Observable<FundDTO[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<FundDTO[]>><any>Observable.throw(response_);
        });
    }

    protected processApiFundsGet(response: HttpResponseBase): Observable<FundDTO[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            response instanceof HttpErrorResponse ? response.error : undefined;
        ...
        return Observable.of<FundDTO[]>(<any>null);
    }
    ...
    apiInvestmentsGet(): Observable<InvestmentDTO[]> {
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            return this.processApiInvestmentsGet(response_);
        }).catch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
     ...
     * @return Success
     */
    apiTransactionsRecalculatePost(): Observable<void> {
        ...
        return this.http.request("post", url_, options_).flatMap((response_ : any) => {
            return this.processApiTransactionsRecalculatePost(response_);
        }).catch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApiTransactionsRecalculatePost(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>Observable.throw(e);
                }
            } else
    ...
    protected processApiTransactionsRecalculatePost(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            response instanceof HttpErrorResponse ? response.error : undefined;
...
export class InvestmentDTO implements IInvestmentDTO {
    ...
    buyFiatRate?: number | undefined;
    buyFiatAmount?: number | undefined;
    readonly sellAmount?: number | undefined;
    readonly sellCurrency?: string | undefined;
    readonly rate?: number | undefined;
    currentFiatValue?: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.buyFiatRate = data["buyFiatRate"];
            this.buyFiatAmount = data["buyFiatAmount"];
            (<any>this).sellAmount = data["sellAmount"];
            (<any>this).sellCurrency = data["sellCurrency"];
            (<any>this).rate = data["rate"];
            this.currentFiatValue = data["currentFiatValue"];
