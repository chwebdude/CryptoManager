...
import { CryptoApiClient, IExchangeMeta, Exchange, ExchangeDTO, ExchangeSecretsDTO } from '../services/api-client.service';
...
export class ExchangesComponent implements OnInit {
    ...
    constructor(private apiClient: CryptoApiClient/*, private confirmationService: ConfirmationService*/) {
        ...
        apiClient.availableExchanges().subscribe(ex => {
            for (let entry of ex) {
    ...
    addExchange() {
        let exchange = new ExchangeSecretsDTO({
        ...
        this.apiClient.exchanges

        this.apiClient.exchangesexchangesPost(exchange).subscribe(res => {
            this.comment = "";
            this.publicKey = "";
            this.privateKey = "";
            this.passphrase = "";
